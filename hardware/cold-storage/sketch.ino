...
// Replace this after deploying your backend. Leave unchanged for Serial-only testing.
...
void sendToBackend(const String& payload) {
  ...
  client.setInsecure(); // Prototype only; production should validate TLS certificates.
  HTTPClient http;
